<div data-overlay-theme="a" data-role="popup" id="popupAddPolicy" class="policy-popup" data-position-to="window" data-clear_on_cancel="true">
    ...
    <div class="popup-content">
        <form class="policy-form">
            ...
            <input name="renewal" class="renewal" type="text" data-role="datebox" data-clear-btn="true" 
                   data-options='{"mode":"calbox", "calUsePickers": true,"useNewStyle":true, "closeCallback":"showPopup", "closeCallbackArgs":["#popupAddPolicy"]}'>
