<div data-overlay-theme="a" data-role="popup" id="popupAddApp" class="add-appointment-popup" data-position-to="window" data-clear_on_cancel="true">
    ...
    <div class="popup-content">
        <form class="appointment-form">
            <input type="hidden" name="id" id="appointment_id" value="0">
            <input type="hidden" name="fn" class="fn" value="add">
            ...
            <input name="begin_date" class="begin_date" type="text" data-role="datebox" data-clear-btn="true" 
                   data-options='{"mode":"calbox", "calUsePickers": true,"useNewStyle":true, "closeCallback":"showPopup", "closeCallbackArgs":["#<?php echo $pageId ?> .add-appointment-popup"]}'>
            ...
            <input name="start_time" class="start_time" type="text" data-role="datebox" 
                   data-options='{"mode":"timebox", "useNewStyle":true, "closeCallback":"showPopup", "closeCallbackArgs":["#<?php echo $pageId ?> .add-appointment-popup"], "minuteStep":15}' data-clear-btn="true">
