        ...
        <li style="padding: 5px">
            <fieldset class="ui-grid-c">
                <div class="ui-block-a">
                    <button id="use-my-location" class="locate-postcode" 
                            type="submit" data-icon="location" data-iconpos="right">Find my Location</button>
                </div>
                ...
                <div class="ui-block-c">
                    <?php echo form_open("planner/printable/$sqldate", array('data-ajax' => 'false', 'onsubmit' => "$.mobile.loading( 'show')")); ?>
                    <button data-icon="print-ico-btn" data-iconpos="right" type="submit">Print View</button>
                    </form>
                </div>

                <div class="ui-block-d">
                    <input <? if(!empty($date)): echo "value='$date'"; endif ?> name="date" id="plan-date" class="plan-date" type="text" data-role="datebox" data-clear-btn="true" 
    ...
    <ul id="planner-ct" data-role="listview" data-inset="true">
        <?php foreach ($prospects as $prospect): $noaddress = false; ?>
            <li class="planner" id="<?php echo $prospect['urn']; ?>" data-postcode="<?php echo $prospect['p_postcode']; ?>">
                <a href="<? echo base_url() ?>index.php/leads/detail/<?php echo $prospect['urn']; ?>">
                    <h2 class="coname"><?php echo $prospect['coname']; ?></h2>
                    <p><strong class="label">URN:</strong> <span class="urn"><?php echo $prospect['urn']; ?></span></p>
                    <p><strong class="label">Date:</strong> <span class="date"><? if ($prospect['date']): ?><?php echo date('d/m/y', strtotime($prospect['date'])); else: echo "Not Set"; endif;?></span></p>
                    ...
                    <p>
                        ...
                        <?php if ($prospect['p_postcode'] && $prospect['p_add1']): ?>
                            ...
                            <span class="postcode hidden"><? echo $prospect['p_postcode']; ?></span>
...
<?php else: ?> <!-- There we no results returned by the search -->
    ...
    <ul data-inset="true" data-role="listview" class="listview-white">
        ...
        <li>
            <form data-ajax="false" action="../prospects">
...
<?php endif; ?>
<div class="hidden">
    <input id="date-holder" data-role="datebox"
